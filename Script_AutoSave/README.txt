...
✅ 4. Actions Tab
    ...
    Add arguments: -ExecutionPolicy Bypass -File "path_to_your_script"
...
✅ 5. Conditions and Settings Tabs
    ...
    - You can uncheck: "Start the task only if the computer is on AC power" ⚡

    - And check: "Run task as soon as possible after a scheduled start is missed"